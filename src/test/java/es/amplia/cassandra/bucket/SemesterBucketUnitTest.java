...
public class SemesterBucketUnitTest {
    ...
    public void given_several_ranges_of_dates_when_get_intervals_invoked_on_bucket_then_it_returns_expected_interval_between_them () throws ParseException {
        assertThat(when_get_intervals_invoked_on_bucket(bucket, format.parse("01/01/1970 0:00:00.000"), format.parse("30/06/1970 23:59:59.999")),
                contains(1L));

        assertThat(when_get_intervals_invoked_on_bucket(bucket, format.parse("30/06/1970 23:59:59.999"), format.parse("01/07/1970 0:00:00.000")),
                contains(1L, 2L));

        assertThat(when_get_intervals_invoked_on_bucket(bucket, format.parse("30/06/1970 23:59:59.999"), format.parse("01/01/1971 0:00:00.000")),
                contains(1L, 2L, 3L));
    ...
    private Map<Long, Date> given_a_collection_of_dates () throws ParseException {
        ...
        map.put(1L, format.parse("30/06/1970 23:59:59.999"));
        map.put(2L, format.parse("01/07/1970 0:00:00.000"));
        map.put(2L, format.parse("31/12/1970 23:59:59.999"));
        map.put(3L, format.parse("01/01/1971 0:00:00.000"));
        map.put(3L, format.parse("30/06/1971 23:59:59.999"));
        map.put(93L, format.parse("01/01/2016 0:00:00.000"));
        map.put(94L, format.parse("31/12/2016 23:59:59.999"));
        return map;
    }
